...
<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1" />
<title>檢舉文章資料修改 - update_report_input.jsp</title>
			...
			<div class="page-breadcrumb">
				...
				<FORM METHOD="post"
					...
					<table>
						...
						<tr>
							...
							<td><select size="1" name="ad_status">
									<c:forEach var="reportStatus" items="${reportStatusMap}">
										<option value="${reportStatus.key}"
											${(reportVO.report_status == report.key)?'selected':''}>${reportStatus.value}
									</c:forEach>
							</select></td>
						</tr>
						<tr>
					...
					<input type="hidden" name="report_ID"
						value="<%=reportVO.getReport_ID()%>"> <input type="submit"
						value="送出修改">
				</FORM>
</body>
...
<script>
        ...
        $('#f_date1').datetimepicker({
           theme: '',              //theme: 'dark',
 		   ...
 		   value: '<%=reportVO.getReport_start()%>
	', // value:   new Date(),
