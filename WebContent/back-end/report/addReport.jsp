...
<table>
	...
	<tr>
		...
		<td><input type="TEXT" name="report_title" size="45" 
			 value="<%= (reportVO==null)? "請選擇所要的檢舉文章標題" :reportVO.getReport_title() %>" /></td>
	</tr>

	<tr>
		<td>檢舉分類:</td>
		<td><input type="TEXT" name="report_sort" size="45" 
			 value="<%= (reportVO==null)? "請選擇所要的檢舉文章分類" :reportVO.getReport_sort()%>" /></td>
	</tr>
	...
	<tr>
		...
		<td><input type="TEXT" name="report_con" size="45" 
			 value="<%= (reportVO==null)? "請選擇檢舉文章內容" : reportVO.getReport_con()%>" /></td>
	</tr>
