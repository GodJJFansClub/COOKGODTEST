...
<table id="table-1">
	<tr><td>
		 <h3>所有菜色資料<br><font color=red>listAllEmp_06_EL_Test_<font color=blue>Bootstrap_modal</font>.jsp</font></h3>
...
<table>
	...
	<c:forEach var="dishVO" items="${dishDAO.all}" varStatus="s">
		
		<tr>
			<td><A href="<%=request.getContextPath()%>/dish/dish.do?dish_ID=${dishVO.dish_ID}&action=getAllDish">${dishVO.dish_ID}</a></td>
