...
<body bgcolor='white'>
	...
	<FORM METHOD="post" ACTION="<%=request.getContextPath()%>/cust/cust.do"
		...
		<table>
			...
			<tr>
				<td>顧客生日:</td>
				<td><input type="text" name="cust_brd"  id="f_date1" size="45" 
				></td>
			</tr>
			...
			<tr>
				<td>顧客狀態:</td>
				<td><input type="radio" name="cust_status" size="10" value="a0" checked/>未停權
					<input type="radio" name="cust_status" size="10" value="a1" />停權</td>
			</tr>
			...
			<tr>
				<td>顧客大頭照:</td>
				<td><input type="file" name="cust_pic" size="45" id="doc"onchange="javascript:setImagePreview();"/></td>
			</tr>
