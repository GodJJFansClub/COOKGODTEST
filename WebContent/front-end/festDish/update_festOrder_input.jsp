...
<%
	FestDishVO festDishVO = (FestDishVO) request.getAttribute("festDishVO"); //EmpServlet.java (Concroller) 存入req的empVO物件 (包括幫忙取出的empVO, 也包括輸入資料錯誤時的empVO物件)
%>
...
<table id="table-1">
	<tr><td>
		 <h3>節慶主題料理訂單修改 - update_festDish_input.jsp</h3>
