		...
		<table>
			...
			<tr>
				...
				<td><input type="date" name="fest_or_start"
					value="<%=(festOrderVO == null) ? "2000" : festOrderVO.getFest_or_start()%>" /></td>
			</tr>

			<tr>
				<td>出貨日期:</td>
				<td><input type="date" name="fest_or_send"
					value="<%=(festOrderVO == null) ? "2000" : festOrderVO.getFest_or_send()%>" /></td>
			</tr>

			<tr>
				<td>訂單結束日期:</td>
				<td><input type="date" name="fest_or_end"
					value="<%=(festOrderVO == null) ? "2000" : festOrderVO.getFest_or_end()%>" /></td>
			</tr>
