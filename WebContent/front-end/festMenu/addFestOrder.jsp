...
<table id="table-1">
	<tr><td>
		 <h3>節慶主題料理訂單新增 - addFestMenu.jsp</h3></td><td>
...
<table>
	...
	<tr>
		...
		<td><input type="TEXT" name="fest_or_status" size="45" 
			 value="<%= (festMenuVO==null)? "3" :festMenuVO.getFest_or_status() %>" /></td>
	</tr>

	<tr>
		<td>價格:</td>
		<td><input type="TEXT" name="fest_or_price" size="45" 
			 value="<%= (festMenuVO==null)? "2000" :festMenuVO.getFest_or_price()%>" /></td>
	</tr>
	
	<tr>
		<td>訂單成立日期:</td>
		<td><input type="date" name="fest_or_start" value="<%= (festMenuVO==null)?
				"2000" :festMenuVO.getFest_or_start()%>"/></td>
	</tr>
	
	<tr>
		<td>出貨日期:</td>
		<td><input type="date" name="fest_or_send" value="<%= (festMenuVO==null)? 
				"2000" :festMenuVO.getFest_or_send()%>"/></td>
	</tr>
	
	<tr>
		<td>訂單結束日期:</td>
		<td><input type="date" name="fest_or_end" value="<%= (festMenuVO==null)? 
				"2000" :festMenuVO.getFest_or_end()%>"/></td>
	</tr>
	
	<tr>
		<td>折扣:</td>
		<td><input type="TEXT" name="fest_or_disc" size="45" 
			 value="<%= (festMenuVO==null)? "0.8" : festMenuVO.getFest_or_disc()%>" /></td>
	</tr>
	
	<tr>
		<td>會員編號:</td>
		<td><input type="TEXT" name="cust_ID" size="45" 
			 value="<%= (festMenuVO==null)? "C00001" : festMenuVO.getCust_ID()%>" /></td>
	</tr>
</table>
<br>
