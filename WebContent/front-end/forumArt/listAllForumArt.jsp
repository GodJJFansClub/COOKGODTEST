...
<jsp:useBean id="forumArtDAO"  scope="page" class="com.forumArt.model.ForumArtDAO" />
<jsp:useBean id="forumArtSvc"  scope="page" class="com.forumArt.model.ForumArtDAO" />
...
<table id="table-1">
	<tr><td>
		 <h3>所有文章</h3>
		 <h4><a href="<%=request.getContextPath()%>/back-end/forumArt/select_page.jsp">回首頁</a></h4>
	</td></tr>
</table>
...
<%@ include file="page1.file" %> 
	<c:forEach var="forumArtVO" items="${list}" varStatus="s" begin="<%=pageIndex%>" end="<%=pageIndex+rowsPerPage-1%>">	
		<tr>
		<td>
			<FORM METHOD="post" ACTION="<%=request.getContextPath()%>/forumArt/forumArt.do" style="margin-bottom: 0px;">
			<A href="<%=request.getContextPath()%>/forumArt/forumArt.do?forum_art_ID=${forumArtVO.forum_art_ID}&action=getAllForumArt">${forumArtVO.forum_art_name} </a>
			</FORM>
		</td>
			...
			<td><fmt:formatDate value="${forumArtVO.forum_art_start}" pattern="yyyy-MM-dd HH:mm:ss"/> </td>
