...
Insert into FEST_MENU (FEST_M_ID,FEST_M_NAME,FEST_M_QTY,FEST_M_START,FEST_M_END,FEST_M_SEND,FEST_M_STATUS,FEST_M_KIND,FEST_M_PRICE,CHEF_ID) values ('FM'||LPAD(TO_CHAR(FEST_MENU_SEQ.NEXTVAL),4,'0'),'節慶主題料理名稱一',50,to_date('01-JAN-19','DD-MON-RR'),to_date('01-FEB-19','DD-MON-RR'),to_date('14-FEB-19','DD-MON-RR'),'1','1',1888,'C00002');
Insert into FEST_MENU (FEST_M_ID,FEST_M_NAME,FEST_M_QTY,FEST_M_START,FEST_M_END,FEST_M_SEND,FEST_M_STATUS,FEST_M_KIND,FEST_M_PRICE,CHEF_ID) values ('FM'||LPAD(TO_CHAR(FEST_MENU_SEQ.NEXTVAL),4,'0'),'節慶主題料理名稱二',20,to_date('18-FEB-19','DD-MON-RR'),to_date('01-FEB-19','DD-MON-RR'),to_date('14-FEB-19','DD-MON-RR'),'1','1',2888,'C00008');
Insert into FEST_MENU (FEST_M_ID,FEST_M_NAME,FEST_M_QTY,FEST_M_START,FEST_M_END,FEST_M_SEND,FEST_M_STATUS,FEST_M_KIND,FEST_M_PRICE,CHEF_ID) values ('FM'||LPAD(TO_CHAR(FEST_MENU_SEQ.NEXTVAL),4,'0'),'節慶主題料理名稱三',50,to_date('05-FEB-19','DD-MON-RR'),to_date('01-FEB-19','DD-MON-RR'),to_date('14-FEB-19','DD-MON-RR'),'1','1',3888,'C00008');
commit;
