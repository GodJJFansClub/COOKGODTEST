...
public class festDishJNDIDAO implements FestDish_Interface {
	...
	private static final String GET_ALL_STMT = 
			"SELECT * FROM FEST_DISH";
	private static final String GET_ONE_STMT = 
			"SELECT * FROM FEST_DISH WHERE DISH_ID = ?";
	private static final String DELETE = 
			"DELETE FROM FEST_DISH WHERE DISH_ID = ?";
	private static final String UPDATE = 
			"UPDATE FEST_DISH SET FEST_M_ID = ? WHERE DISH_ID = ?";
	...
	public List<FestDishVO> getAll() {
		...
		try {
			...
			while (rs.next()) {
				...
				list.add(festDishVO); // Store the row in the list
			}
