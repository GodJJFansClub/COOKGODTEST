...
public class ChefDishDAO implements ChefDishDAO_Interface{
	...
	private static final String Delete_Stmt = 
			"DELETE FROM CHEF_DISH WHERE CHEF_ID = ? AND DISH_ID = ?";
	...
	public void update(ChefDishVO chefDishVO) {
		...
		try {
			...
			pstmt.setString(1, chefDishVO.getChef_dish_status());
			pstmt.setString(2, chefDishVO.getChef_ID());
			pstmt.setString(3, chefDishVO.getDish_ID());
